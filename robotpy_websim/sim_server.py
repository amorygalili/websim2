...
class Main:
    ...
    def server_thread(self):
        ...
        app = tornado.web.Application([
            ...
            (r"/dependencies/(.*)", MyStaticFileHandler, {"path": self.dependencies_path}),
    ...
    def run(self, options, robot_class, **kwargs):
        ...
        # Path where bower components are served from
        self.dependencies_path = abspath(join(dirname(__file__), '../bower_components'))
        ...
        # Minifies module js and css, and add templates in the sim folder
        subprocess.call(['grunt', '--simPath=' + self.sim_path], shell=True)
